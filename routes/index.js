...
router.get('/producten', function(req, res, next) {
  Product.find(function(error, docs) {    // Product.find() zoekt alles wat er aan producten te vinden valt, => docs in de callback
    ...
    res.render('shop/producten', { title: 'Shopping cart', products: docs, gelukt, noYay: !gelukt});  // renderfunctie met te renderen dingen, products is de term in de view, die hier wordt gelijkgesteld met die chunks. Deze moet in de Products.find, anders gebeurt het renderen (synchronous) voordat find (asynchronous) klaar is
  });
});
...
idealiter: bestellingsformulier verbeteren: 
...
.
Denk dat je meer zou moeten doen met donkerrood en lichtgrijs - de kleuren van het logo
